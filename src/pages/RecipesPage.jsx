    ...
    <div className="p-6">
      <div className="flex justify-between mb-6">
        <input
          ...
          className=" border-width:4px-solid rounded-md bg-slate-200 text-center dark:bg-gray-800 text-gray-800 dark:text-white w-full sm:w-auto"
        />
        <Link
          to="/add-recipe"
          className="bg-green-700 text-white py-2 px-2 ml-3 text-center  rounded-md"
        >
          Add New Recipe
        </Link>
      </div>
      ...
      <div className="grid md:grid-cols-3 sm:grid-cols-1 lg:grid-cols-3 gap-5">
